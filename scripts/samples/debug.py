...
def conv_net(x, W, b):
    ...
    conv5 = convolve_inner_layers(conv4, W['weights5'], b['bias5'])
    output = convolve_ouput_layer(conv5, W['weights_out'], b['bias_out'])
    return output
...
def main():
    weights = {
        ...
        'weights4': tf.Variable(tf.random_normal([11,11,7,5])),
        'weights5': tf.Variable(tf.random_normal([11,11,5,3])),
    ...
    biases = {
        ...
        'bias4': tf.Variable(tf.random_normal([5])),
        'bias5': tf.Variable(tf.random_normal([3])),
