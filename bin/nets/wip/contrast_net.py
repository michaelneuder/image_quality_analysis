...
def main():
    ...
    contrast_500= pd.read_csv('{}contrast_500.csv'.format(data_path), header=None)
    contrast_140 = pd.read_csv('{}contrast_140.csv'.format(data_path), header=None)
    ...
    # target values
    training_target = contrast_500.values
    testing_target = contrast_140.values
