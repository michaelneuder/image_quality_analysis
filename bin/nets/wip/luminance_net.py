...
def main():
    ...
    orig_500 = pd.read_csv('{}ds2_orig_500.txt'.format(data_path), header=None, delim_whitespace = True)
    recon_500 = pd.read_csv('{}ds2_recon_500.txt'.format(data_path), header=None, delim_whitespace = True)

    # test data --- 140 images, 96x96 pixels
    orig_140 = pd.read_csv('{}ds2_orig_140.txt'.format(data_path), header=None, delim_whitespace = True)
    recon_140 = pd.read_csv('{}ds2_recon_140.txt'.format(data_path), header=None, delim_whitespace = True)
