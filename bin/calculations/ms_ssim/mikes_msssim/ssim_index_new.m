...
mu1   = filter2(win, img1, 'same');
mu2   = filter2(win, img2, 'same');
mu1_sq = mu1.*mu1;
mu2_sq = mu2.*mu2;
mu1_mu2 = mu1.*mu2;
sigma1_sq = filter2(win, img1.*img1, 'same') - mu1_sq;
sigma2_sq = filter2(win, img2.*img2, 'same') - mu2_sq;
sigma12 = filter2(win, img1.*img2, 'same') - mu1_mu2;
